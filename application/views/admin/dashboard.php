...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <!-- Modal -->
        <div class="modal fade" id="infostatus" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
            aria-hidden="true">
                ...
                },
                {
                    render: function(data, type, row) {
                        return '<button data-id="' + row.pengaduan_id_pengaduan +
                            '" class="status btn btn-warning" data-toggle="modal" data-target="#infostatus">Verifikasi</button>'
                    }
                },
                {
                    render: function(data, type, row) {
