        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <div class="content-wrapper">
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="infostatus" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    Data di teruskan Ke proses
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">OK</button>
                                    <a href="/admin/dataproses" role="button" class="btn btn-info">ke Proses</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                return '<button data-id="'+row.pengaduan_id_pengaduan+'" class="status btn btn-warning" data-toggle="modal" data-target="#infostatus">Verifikasi</button>'
                }},
                {render: function (data, type, row){
                return '<button data-id="'+row.pengaduan_id_pengaduan+'" '+
                ...
                <script type="text/javascript" src="/assets/js/dashboardadmin.js"></script>
            </body>
        </html>