...
<body class="hold-transition sidebar-mini">
    ...
    $(function() {
        ourtable = $("#datareal").DataTable({
            ...
            columns: [{
                ...
                {
                    render: function(data, type, row) {
                        return '<button class="btn btn-success">Selesai</button>'

                    }
                },
                {
                    render: function(data, type, row) {
                        return '<a href="/admin/generate_laporan?id=" target="_blank" role="button" class="generate btn btn-info"><i class="fa fa-file" aria-hidden="true"></i></a>' +
                            '<span> </span>' +
                            '<button data-id="' + row.pengaduan_id_pengaduan +
                            '" class="btn btn-info"><i class="fa fa-search" aria-hidden="true"></i></button>' +
                            '<span> </span>' +
                            '<button data-id="' + row.pengaduan_id_pengaduan +
                            '" class="del btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button>'
                    }
                }
            ]
        });
    ...
    <script type="text/javascript" src="/assets/js/dashboardadmin_s.js"></script>
</body>
