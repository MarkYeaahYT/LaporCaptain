        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <div class="content-wrapper">
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="modal_tanggap" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                ...
                'class="status btn btn-info">Validasi</button>'
                }},
                {render: function (data, type, row){
