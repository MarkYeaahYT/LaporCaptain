...
<html lang="en">
    <head>
        ...
        <title>Register Untuk Admin</title>
        <!-- Favicon-->
                    ...
                    <div class="container-fluid">
                        <div class="row justify-content-center" style="padding-top: 12%;">
                            <div class="col-6">
                                ...
                                <div class="card">
                                    <form  method="POST" action="<?php echo site_url('app/registersecret_proses') ?>">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="nama">Nama</label>
                                                <input type="text" name="nama" class="form-control" id="nama" aria-describedby="emailHelp" placeholder="Enter Nama">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" value="petugas" name="level" id="flexRadioDefault2">
