    ...
    <body class="hold-transition sidebar-mini">
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="/petugas/dataproses" role="button" class="btn btn-info">ke Proses</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                return '<button data-id="'+row.pengaduan_id_pengaduan+'" class="status btn btn-warning" data-toggle="modal" data-target="#infostatus">0</button>'
                }},
                {render: function (data, type, row){
